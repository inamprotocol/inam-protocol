...
- Porting the Job resource (§3) to the Cloudflare Worker deployment and to both SDKs — implemented in the Node reference server only as of this draft.
